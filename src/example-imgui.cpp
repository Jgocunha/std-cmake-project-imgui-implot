...
void UserInterface::init()
{
    ...
    windowClass = { sizeof(windowClass), CS_CLASSDC, WndProc, 0L, 0L,
        GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"TestProject", nullptr };
    ::RegisterClassExW(&windowClass);
    windowHandle = ::CreateWindowW(windowClass.lpszClassName, L"TestProject",
...
void UserInterface::scatterPlotDemo()
{
    srand(0);
